...
export MACOS_10_14_TAG="eosio-cdt-macos-10.14-$(sha1sum ./.cicd/docker/macos-10.14.sh | awk '{print $1}')"
export MACOS_10_15_TAG="eosio-cdt-macos-10.15-$(sha1sum ./.cicd/docker/macos-10.15.sh | awk '{print $1}')"
