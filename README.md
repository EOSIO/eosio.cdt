...
```sh
$ wget https://github.com/turnpike/eoscc/releases/download/v1.7.0/eoscc_1.7.0-1-ubuntu-20.04_amd64.deb
$ sudo apt install ./eoscc_1.7.0-1-ubuntu-20.04_amd64.deb
```
