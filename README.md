...
```sh
$ wget https://github.com/eosio/eosio.cdt/releases/download/v1.5.0-rc2/eosio.cdt-1.5.0-rc2-1_amd64.deb
$ sudo apt install ./eosio.cdt-1.5.0-rc2-1_amd64.deb
```
...
```sh
$ wget https://github.com/eosio/eosio.cdt/releases/download/v1.5.0-rc2/eosio.cdt-1.5.0-1.fc27.x86_64.rpm
$ sudo yum install ./eosio.cdt-1.5.0-rc2-1.fc27.x86_64.rpm
```
...
```sh
$ wget https://github.com/eosio/eosio.cdt/releases/download/v1.5.0-rc2/eosio.cdt-1.5.0-rc2-1.el7.x86_64.rpm
$ sudo yum install ./eosio.cdt-1.5.0-rc2-1.el7.x86_64.rpm
```
