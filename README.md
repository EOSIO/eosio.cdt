...
```sh
$ wget https://github.com/eosio/eosio.cdt/releases/download/v1.5.0/eosio.cdt_1.5.0-1.fc27.x86_64.rpm
$ sudo yum install ./eosio.cdt_1.5.0-1.fc27.x86_64.rpm
```
...
```sh
$ wget https://github.com/eosio/eosio.cdt/releases/download/v1.5.0/eosio.cdt_1.5.0-1.el7.x86_64.rpm
$ sudo yum install ./eosio.cdt_1.5.0-1.el7.x86_64.rpm
```
