...
class [[eosio::contract]] kv_addr_book : public eosio::contract {
   ...
   private:
      ...
      struct [[eosio::table]] address_table : eosio::kv::table<person, "kvaddrbook"_n> {
         ...
         index<std::pair<std::string, std::string>> country_personal_id_uidx {
            ...
            &value_type::country_personal_id };
   ...
   public:
      ...
      using get_by_last_name_action = eosio::action_wrapper<"getbylstname"_n, &kv_addr_book::getbylstname>;
