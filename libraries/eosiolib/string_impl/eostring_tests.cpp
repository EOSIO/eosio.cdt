...
{  
   ...
   assert(eostr_cpy.capacity() == eostr.capacity() && eostr_cpy.capacity() == 6);
   ...
   assert(eostr_assig.capacity() == eostr.capacity() && eostr_assig.capacity() == 6);
   ...
   assert(eostr.size()              == 0);
   assert(eostr_mv_assig.capacity() == 6);
   assert(eostr.size()              == 0);
