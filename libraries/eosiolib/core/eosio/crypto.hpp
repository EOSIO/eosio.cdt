...
namespace eosio {
    ...
    *  1. 0 - a ECC K1 public key
    *  2. 1 - a ECC R1 public key
    *  3. 2 - a WebAuthN public key (requires the host chain to activate the WEBAUTHN_KEY consensus upgrade)
    */
    ...
    * \tparam DataStream Type of datastream buffer
    * \returns DataStream& Reference to the datastream
    */
    ...
    *  1. 0 - a ECC K1 signature,
    *  2. 1 - a ECC R1 signature,
    *  3. 2 - a WebAuthN signature (requires the host chain to activate the WEBAUTHN_KEY consensus upgrade)
    */
    ...
    * \notes This method is optimized to a NO-OP when in fast evaluation mode.
    */
    ...
    * \param data Data you want to hash
    * \param length Data length
    * \returns eosio::checksum256 Computed digest
    */
    ...
    * \param data Data you want to hash
    * \param length Data length
    * \returns eosio::checksum160 Computed digest
    */
    ...
    * \param data Data you want to hash
    * \param length Data length
    * \returns eosio::checksum512 Computed digest
    */
    ...
    * \param sig Signature
    * \returns eosio::public_key Recovered public key
    */
