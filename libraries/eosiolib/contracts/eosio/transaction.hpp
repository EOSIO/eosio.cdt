...
namespace eosio {
   ...
   */
   ...
   public:
       ...
       */
      transaction_header( time_point_sec exp = time_point_sec((current_time().count()/1000000) + 60) )
         :expiration(exp)
      {}
   ...
   public:
       ...
       */
      transaction(time_point_sec exp = time_point_sec((current_time().count()/1000000) + 60)) : transaction_header( exp ) {}
