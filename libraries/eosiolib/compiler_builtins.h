...
extern "C" {
  ...
  *
  * @details Multiply two 128 bit integers split as two 64 bit unsigned integers and assign the value to the first parameter.
  ...
  *
  * @details Divide two 128 bit integers split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Divide two 128 bit unsigned integers split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Perform modular arithmetic on two 128 bit integers split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Perform modular arithmetic on two 128 unsigned bit integers split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
...
/**
  ...
  *
  * @details Perform logical shift left on a 128 bit integer split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res    It will be replaced with the result product.
  ...
  *
  * @details Perform logical shift right on a 128 bit integer split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res    It will be replaced with the result product.
  * @param lo     Low 64 bits of the 128 bit factor.
  * @param hi     High 64 bits of the 128 bit factor.
  * @param shift  Number of bits to shift.
...
/**
  ...
  *
  * @details Perform arithmetic shift left on a 128 bit integer split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res    It will be replaced with the result product.
  * @param lo     Low 64 bits of the 128 bit factor.
  * @param hi     High 64 bits of the 128 bit factor.
  * @param shift  Number of bits to shift.
  ...
  *
  * @details Perform arithmetic shift right on a 128 bit integer split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res    It will be replaced with the result product.
  * @param lo     Low 64 bits of the 128 bit factor.
  * @param hi     High 64 bits of the 128 bit factor.
  * @param shift  Number of bits to shift.
  ...
  *
  * @details Add two long doubles split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Subtract two long doubles split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Multiply two long doubles split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Divide two long doubles split as two 64 bit unsigned integers and assign the value to the first parameter.
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check equality between two doubles split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check inequality between two doubles split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check if the first double is greater or equal to the second double, the doubles are split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check if the first double is greater than the second double, the doubles are split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check if the first double is less or equal to the second double, the doubles are split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check if the first double is less than the second double, the doubles are split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Compare two doubles which are split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Check if either of the doubles is NaN, the doubles are split as two 64 bit unsigned integers
  * @param res  It will be replaced with the result product.
  * @param la   Low 64 bits of the first 128 bit factor.
  * @param ha   High 64 bits of the first 128 bit factor.
  * @param lb   Low 64 bits of the second 128 bit factor.
  ...
  *
  * @details Convert long double (which are split as two 64 bit unsigned integers) into 64 bit integer
  ...
  *
  * @details Convert long double (which are split as two 64 bit unsigned integers) into 32 bit integer
  * @param l   Low 64 bits of the first 128 bit factor.
  * @param h   High 64 bits of the first 128 bit factor.
  ...
  *
  * @details Convert long double (which are split as two 64 bit unsigned integers) into 64 bit unsigned integer
  * @param l   Low 64 bits of the first 128 bit factor.
  * @param h   High 64 bits of the first 128 bit factor.
  ...
  *
  * @details Convert long double (which are split as two 64 bit unsigned integers) into 32 bit unsigned integer
  * @param l   Low 64 bits of the first 128 bit factor.
  * @param h   High 64 bits of the first 128 bit factor.
  ...
  *
  * @details Truncate long double (which are split as two 64 bit unsigned integers) into double
  * @param l   Low 64 bits of the first 128 bit factor.
  * @param h   High 64 bits of the first 128 bit factor.
  ...
  *
  * @details Truncate long double (which are split as two 64 bit unsigned integers) into float
  * @param l   Low 64 bits of the first 128 bit factor.
  * @param h   High 64 bits of the first 128 bit factor.
