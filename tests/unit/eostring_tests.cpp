...
EOSIO_TEST_BEGIN(eostring_test)
   ...
   //    CHECK_EQUAL( eostr0.data() == eostr0_cpy.data(), true );

   //    CHECK_EQUAL( eostr1_cpy.size(), 1 );
   //    CHECK_EQUAL( eostr1_cpy.capacity(), 1 );
   //    CHECK_EQUAL( strcmp(eostr1_cpy.data(), "a"), 0 );
   //    CHECK_EQUAL( eostr1.data() == eostr1_cpy.data(), true );

   //    CHECK_EQUAL( eostr2_cpy.size(), 6 );
   //    CHECK_EQUAL( eostr2_cpy.capacity(), 6 );
   //    CHECK_EQUAL( strcmp(eostr2_cpy.data(), "abcdef"), 0 );
   //    CHECK_EQUAL( eostr2.data() == eostr2_cpy.data(), true );
   // }

   // {
   //    static eosio::eostring eostr0{""};    eostr0 += "a"; //////////////////////////////
   //    static eosio::eostring eostr1{"abc"}; eostr1 += "def"; ////////////////////////////
   //    static eosio::eostring eostr0_cpy{eostr0}; // Fails here. /////////////////////////
   //    static eosio::eostring eostr1_cpy{eostr1}; // Fails here. /////////////////////////

   //    CHECK_EQUAL( eostr0_cpy.size(), 1 ); //////////////////////////////////////////////
   //    CHECK_EQUAL( eostr0_cpy.capacity(), 1 ); //////////////////////////////////////////
   //    CHECK_EQUAL( strcmp(eostr0_cpy.data(), "a"), 0 ); /////////////////////////////////
   //    CHECK_EQUAL( eostr0.data() == eostr0_cpy.data(), true ); //////////////////////////

   //    CHECK_EQUAL( eostr1_cpy.size(), 6 ); //////////////////////////////////////////////
   //    CHECK_EQUAL( eostr1_cpy.capacity(), 6 ); //////////////////////////////////////////
   //    CHECK_EQUAL( strcmp(eostr1_cpy.data(), "abcdef"), 0 ); ////////////////////////////
   //    CHECK_EQUAL( eostr1.data() == eostr1_cpy.data(), true ); //////////////////////////
   // }
   ...
   //    static const eosio::eostring eostr2_mv{std::move(eostr2)};
   ...
   //    static eosio::eostring eostr0{""};    eostr0 += "a"; //////////////////////////////
   //    static eosio::eostring eostr1{"abc"}; eostr1 += "def"; ////////////////////////////
   //    static eosio::eostring eostr0_cpy{std::move(eostr0)}; // Fails here. //////////////
   //    static eosio::eostring eostr1_cpy{std::move(eostr1)}; // Fails here. //////////////
   ...
   //    static const eosio::eostring eostr1{"a"};
   //    static const eosio::eostring eostr2{"abcdef"};
   //    static eosio::eostring eostr0_cpy_assig{};
   //    static eosio::eostring eostr1_cpy_assig{};
   //    static eosio::eostring eostr2_cpy_assig{};
   ...
   //    CHECK_EQUAL( strcmp(eostr2.data(), eostr2_cpy_assig.data()), 0 )
   // }
   ...
   //    static eosio::eostring eostr0_cpy_assig{}; //////////////////////////////////////////
   //    static eosio::eostring eostr1_cpy_assig{}; //////////////////////////////////////////
   //    eostr0_cpy_assig = eostr0;  // Fails here. //////////////////////////////////////////
   //    eostr1_cpy_assig = eostr1;  // Fails here. //////////////////////////////////////////
   ...
   //// eosio::eostring& operator=(eosio::eostring&& str)
   {
      ...
      static eosio::eostring eostr1{"a"};
      static eosio::eostring eostr2{"abcdef"};
      static eosio::eostring eostr0_mv_assig{};
      static eosio::eostring eostr1_mv_assig{};
      static eosio::eostring eostr2_mv_assig{};
      eostr0_mv_assig = std::move(eostr0);
      eostr1_mv_assig = std::move(eostr1);
      eostr2_mv_assig = std::move(eostr2);
      
      CHECK_EQUAL( eostr0_mv_assig.size(), 0 );
      CHECK_EQUAL( eostr0_mv_assig.capacity(), 0 );
      CHECK_EQUAL( strcmp(eostr0_mv_assig.data(), ""), 0 );
      CHECK_EQUAL( strcmp(eostr0.data(), eostr0_mv_assig.data()), 1 )

      CHECK_EQUAL( eostr1_mv_assig.size(), 1 );
      CHECK_EQUAL( eostr1_mv_assig.capacity(), 1 );
      CHECK_EQUAL( strcmp(eostr1_mv_assig.data(), "a"), 0 );
      CHECK_EQUAL( strcmp(eostr1.data(), eostr1_mv_assig.data()), 1 )
      ...
      CHECK_EQUAL( strcmp(eostr2.data(), eostr2_mv_assig.data()), 1 )
   }
   ...
   //    static eosio::eostring eostr0_mv_assig{}; //////////////////////////////////////////////
   //    static eosio::eostring eostr1_mv_assig{}; //////////////////////////////////////////////
   //    eostr0_mv_assig = std::move(eostr0); // Fails here. ////////////////////////////////////
   //    eostr1_mv_assig = std::move(eostr1); // Fails here. ////////////////////////////////////
   ...
   //    CHECK_EQUAL( eostr3.capacity(), 14 );
